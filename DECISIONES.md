...
- 2026-09-15 - finances_context suma los pufos activos al liquido, igual que el hero y la foto diaria - sin ellos la variacion del patrimonio que ve CompAI se inventaba una bajada igual a lo que te deben (visto en vivo con life-mcp: -1035 EUR) - Claude
- 2026-09-15 - life-mcp: la logica de Finanzas vive en life-mcp/finanzas.js (espejo de flow/split/ops de la app) con su suite; tool nueva finanzas_contexto lee finances_context en vez de recalcular - Josema autorizo tocar life-mcp; cambio pequeno, test-all en verde, reinicio solo de life-mcp - Claude
- 2026-09-15 - Mejora visual: el chrome reacciona al scroll con data-atributos en <html> (data-header-collapsed, data-nav-hidden) que pone el Shell y pinta el CSS; logica pura en src/lib/ui/scrollChrome.ts - sin re-render de React en cada scroll y sin tocar cada pagina - Claude
- 2026-09-15 - Mejora visual: ChipTabs (components/ui) es la navegacion estandar: 'chips' para categorias, 'line' para sub-pestañas; filtros de listas largas en hoja inferior con 🔍/⚙ e insignia (patron de Movs) - informe de mejora visual §6-10; las filas de botones con borde quedan prohibidas en navegacion nueva - Claude
